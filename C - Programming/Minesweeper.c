...
{
	printf("ÅéóÜãåôå ôéò äéáóôÜóåéò ôïõ ðëÝãìáôïò êáèüò êáé ôï ðëÞèïò ôùí âïìâþí:\n\n");
	...
	do
	{
		...
		if (lines<=0)
			printf("Ôï ðëÞèïò ôùí ãñáììþí ðñÝðåé íá åßíáé ìåãáëÞôåñï ôïõ 0!\n\n");
	}
	while (lines<=0);
	...
	do
	{
		...
		if (rows<=0)
			printf("Ôï ðëÞèïò ôùí óôçëþí ðñÝðåé íá åßíáé ìåãáëÞôåñï ôïõ 0!\n\n");
	}
	while (rows<=0);
	...
	do
	{
		...
		if (bombs<=0 || bombs==(lines*rows))
			printf("Ôï ðëÞèïò ôùí âïìâþí ðñÝðåé íá åßíáé ìåãáëÞôåñï ôïõ 0 êáé ìéêñüôåñï ôïõ %d!\n\n",lines*rows);
	}
